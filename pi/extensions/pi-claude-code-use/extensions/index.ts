// Local copy based on upstream @benvargas/pi-claude-code-use v1.0.0:
// https://github.com/ben-vargas/pi-packages/tree/main/packages/pi-claude-code-use
...
const FLAT_TO_MCP = new Map<string, string>([
	...
	// Local companion mappings
	["web_search", "mcp__exa_gh__web_search"],
	["fetch_content", "mcp__exa_gh__fetch_content"],
	["code_search", "mcp__exa_gh__code_search"],
	["get_search_content", "mcp__exa_gh__get_search_content"],
	["subagent", "mcp__subagents__subagent"],
	["subagents_list", "mcp__subagents__list"],
	["set_tab_title", "mcp__subagents__set_tab_title"],
	["subagent_resume", "mcp__subagents__resume"],
	["write_artifact", "mcp__subagents__write_artifact"],
	["read_artifact", "mcp__subagents__read_artifact"],
	["librarian", "mcp__librarian__search"],
	["perplexity_search", "mcp__perplexity__search"],
]);
...
const COMPANIONS: CompanionSpec[] = [
	...
	{
		dirName: "pi-exa-gh-web-tools",
		packageName: "@coctostan/pi-exa-gh-web-tools",
		aliases: [
			["web_search", "mcp__exa_gh__web_search"],
			["fetch_content", "mcp__exa_gh__fetch_content"],
			["code_search", "mcp__exa_gh__code_search"],
	...
	{
		dirName: "pi-interactive-subagents",
		packageName: "pi-interactive-subagents",
		aliases: [
			["subagent", "mcp__subagents__subagent"],
			["subagents_list", "mcp__subagents__list"],
			["set_tab_title", "mcp__subagents__set_tab_title"],
	...
	{
		dirName: "pi-librarian",
		packageName: "pi-librarian",
		aliases: [["librarian", "mcp__librarian__search"]],
	},
	{
		dirName: "pi-perplexity",
		packageName: "pi-perplexity",
		aliases: [["perplexity_search", "mcp__perplexity__search"]],
	},
];
