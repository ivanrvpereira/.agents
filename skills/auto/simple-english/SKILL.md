...
version: 1.2.0
description: |
  Write or rewrite technical prose (docs, READMEs, runbooks, procedures,
  error messages, release notes) with ASD-STE100 Simplified Technical English
  so it is clear, unambiguous, and free of AI slop. Use when writing such
  text, when the user mentions STE or ASD-STE100, asks to de-slop or simplify
  text, or wants docs that non-native readers can understand.
license: MIT
